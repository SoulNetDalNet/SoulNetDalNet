...
####################################
#  cKc tcl v7.a -=- Cokkie Crew    #
#       The eGGdrOp Style          #
####################################

set vers           "v7.a"    	 ; #TCL's version
...
putlog "\002\!cK4C\002 "
putlog "\002\!cK4C\002  Initializing cKc.tcl"
putlog "\002\!cK4C\002  tcl version 7a"
putlog "\002\!cK4C\002  copyright © 2002 Cokkie Crew ©"
putlog "\002\!cK4C\002 "

if {$numversion < 1030700} {
  putlog "\002\!cK4C\002 *** Can't load cKc.tcl, at least Eggdrop v1.3.7 required!"
  return 0
}
...
bind dcc n restart cmd_restart
bind dcc n rehash cmd_rehash
bind dcc n rehash cmd_die
...
proc mode_+v {nick uhost hand chan rest} {  
 ...
 if {[matchattr $hand Q] == 0} {
  puthelp "NOTICE $nick :\002\!cK4C\002 This command requires you to authenticate yourself. Please /msg $botnick auth <password>"
  return 0
 }
 if {$rest == ""} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Usage: ${CC}+v <nick>"
  return 0
 }
 if {[onchan $rest $chan] == 0} {
  puthelp "NOTICE $nick :\002\!cK4C\002 $rest is not on the channel."
  return 0
 }
 if {[isvoice $rest $chan] == 1} {
  puthelp "NOTICE $nick :\002\!cK4C\002 $rest is already +v"
 }
...
proc mode_Min {nick uhost hand chan rest} { 
 global CC botnick
 if {[matchattr $hand Q] == 0} {
  puthelp "NOTICE $nick :\002\!cK4C\002 This command requires you to authenticate yourself. Please /msg $botnick auth <password>"
  return 0
...
proc mode_+l {nick uhost hand chan rest} { 
 ...
 if {$rest == ""} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Usage: ${CC}+l <limit>"
  return 0
 }
...
proc mode_+k {nick uhost hand chan rest} { 
 ...
 if {$rest == ""} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Usage: ${CC}+k <key>"
  return 0
 }
...
proc mode_+b {nick uhost hand chan rest} { 
 ...
 if {$rest == ""} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Usage: ${CC}+b <hostmask>"
  return 0
 }
...
proc pub_notice {nick uhost hand channel rest} {
 ...
 if {$rest!=""} {
  ...
  putlog "\002\!cK4C\002 <<$nick>> !$hand! Notice $rest"
  return 0
 }
 if {$rest==""} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Usage: notice <nick> <msg>"
 }
}
...
global botnick version CC
 puthelp "NOTICE $nick :\002\!cK4C\002 echo is only available via dcc chat."
} 
...
proc url_read {} {
 ...
 if {![file exists $urlpath]} {
   ...
   close $fd
   putlog "\002\!cK4C\002 Creating url file information."
 }
 if {[file exists $urlpath]} {
...
proc greet_read {} {
 ...
 if {![file exists $greetpath]} {
   ...
   puts $fd "### bnd4C Created on [unixtime]"
   close $fd
   putlog "\002\!cK4C\002 Creating greet file information"
 }
 if {[file exists $greetpath]} {
...
proc email_read {} {
 ...
 if {![file exists $emailpath]} {
   ...
   puts $fd "### !cK4C Created on [unixtime]"
   close $fd
   putlog "\002\!cK4C\002 Creating email file information"
 }
 if {[file exists $emailpath]} {
...
if {(![info exists greet]) || ([array size greet] == 0)} {
  greet_read
  putlog "\002\!cK4C\002 Loading !cK4C Greet File..."
}
if {(![info exists url]) || ([array size url] == 0)} {
  url_read
  putlog "\002\!cK4C\002 Loading !cK4C URL File..."
}
if {(![info exists email]) || ([array size email] == 0)} {
  email_read
  putlog "\002\!cK4C\002 Loading !cK4C E-Mail File..."
}

timer $min cKc_autosave
proc cKc_autosave {} {
 global min
 putlog "\002\!cK4C\002 Automatically backing up greet information"
 greet_save
 putlog "\002\!cK4C\002 Automatically backing up email information"
 email_save
 putlog "\002\!cK4C\002 Automatically backing up url information"
 url_save
 timer $min cKc_autosave
}

proc dcc_flsave {hand idx arg} {
 putcmdlog "\002\!cK4C\002 #$hand# flsave"
 putlog "\002\!cK4C\002 ${hand} requested backup of greet information"
 greet_save
 putlog "\002\!cK4C\002 ${hand} requested backup of email information"
 email_save
 putlog "\002\!cK4C\002 ${hand} requested backup of url information"
 url_save
}
...
proc url_save {} {
 ...
 if {[file exists $urlpath]} {
   ...
   unset start
   close $fd
   putlog "\002\!cK4C\002 saving url information complete."
   return "url_save"
 }
}
...
proc greet_save {} {
 ...
 if {[file exists $greetpath]} {
   ...
   close $fd
   putlog "\002\!cK4C\002 saving greet information complete."
 }
}
...
proc email_save {} {
 ...
 if {[file exists $emailpath]} {
   ...
   unset start
   close $fd
   putlog "\002\!cK4C\002 saving email information complete."
   return "email_save"
 }
}
...
proc pub_greet {nick uhost hand chan rest} {
 ...
 if {$greetinfo == ""} {
   puthelp "NOTICE $nick :\002\!cK4C\002 Usage: ${CC}greet <new greet>"
   return 0
 }
 if {[lindex $greetinfo 0] == "none"} {
   set greet([string tolower $hand]) ""
   putcmdlog "\002\!cK4C\002 #${hand}# greet $greetinfo"
   puthelp "NOTICE $nick :\002\!cK4C\002 Your Greet msg has been removed." 
   return 0
 }
 set greet([string tolower $hand]) "$greetinfo"
 putcmdlog "\002\!cK4C\002 #${hand}# greet $greetinfo"
 puthelp "NOTICE $nick :\002\!cK4C\002 Setting for 'greet' is now $greetinfo"
}
...
proc dcc_greet {hand idx arg} {
 ...
 if {$greetinfo == ""} {
   putdcc $idx "\002\!cK4C\002 Usage: .greet <new greet>"
   return 0
 }
 if {[lindex $greetinfo 0] == "none"} {
   set greet([string tolower $hand]) ""
   putcmdlog "\002\!cK4C\002 #${hand}# greet $greetinfo"
   putdcc $idx "\002\!cK4C\002 Your Greet msg has been removed."
   return 0
 }
 set greet([string tolower $hand]) "$greetinfo"
 putcmdlog "\002\!cK4C\002 #${hand}# greet $greetinfo"
 putdcc $idx "\002\!cK4C\002 Setting for 'greet' is now $greetinfo"
}
...
proc pub_email {nick uhost hand chan rest} { 
 ...
 if {$emailinfo == ""} {
   puthelp "NOTICE $nick :\002\!cK4C\002 Usage: ${CC}email <new email>"
   return 0
 }
 if {[lindex $emailinfo 0] == "none"} {
   set email([string tolower $hand]) ""
   putcmdlog "\002\!cK4C\002 #${hand}# email $emailinfo"
   puthelp "NOTICE $nick :\002\!cK4C\002 Your email msg has been removed."
   return 0
 }
 set email([string tolower $hand]) "$emailinfo"
 putcmdlog "\002\!cK4C\002 #${hand}# email $emailinfo"
 puthelp "NOTICE $nick :\002\!cK4C\002 Setting for 'email' is now $emailinfo"
}
...
proc dcc_email {hand idx arg} { 
 ...
 if {$emailinfo == ""} {
   putdcc $idx "\002\!cK4C\002 Usage: email <new email>"
   return 0
 }
 if {[lindex $emailinfo 0] == "none"} {
   set email([string tolower $hand]) ""
   putcmdlog "\002\!cK4C\002 #${hand}# email $emailinfo"
   putdcc $idx "\002\!cK4C\002 Your email msg has been removed."
   return 0
 }
 set email([string tolower $hand]) "$emailinfo"
 putcmdlog "\002\!cK4C\002 #${hand}# email $emailinfo"
 putdcc $idx "\002\!cK4C\002 Setting for 'email' is now $emailinfo"
}
...
proc pub_chemail {nick uhost hand chan rest} { 
 ...
 if {($emailinfo == "") || ($user == "")} {
   puthelp "NOTICE $nick :\002\!cK4C\002 Usage: ${CC}chemail <new email>"
   return 0
 }
 if {![validuser $user]} {
   puthelp "NOTICE $nick :\002\!cK4C\002 no such user."
   return 0
 }
 if {[lindex $emailinfo 0] == "none"} {
   set email([string tolower $user]) ""
   putcmdlog "\002\!cK4C\002 #${hand}# chemail $user $emailinfo"
   puthelp "NOTICE $nick :\002\!cK4C\002 ${user}'s email msg has been removed."
   return 0
 }
 set email([string tolower $user]) "$emailinfo"
 putcmdlog "\002\!cK4C\002 #${hand}# chemail $user $emailinfo"
 puthelp "NOTICE $nick :\002\!cK4C\002 ${user}'s Setting for 'email' is now $emailinfo"
}
...
proc dcc_chemail {hand idx arg} { 
 ...
 if {($emailinfo == "") || ($user == "")} {
   putdcc $idx "\002\!cK4C\002 Usage: ${CC}chemail <new email>"
   return 0
 }
 if {![validuser $user]} {
   putdcc $idx "\002\!cK4C\002 no such user."
   return 0
 }
 if {[lindex $emailinfo 0] == "none"} {
   set email([string tolower $user]) ""
   putcmdlog "\002\!cK4C\002 #${hand}# chemail $user $emailinfo"
   putdcc $idx "\002\!cK4C\002 ${user}'s email msg has been removed."
   return 0
 }
 set email([string tolower $user]) "$emailinfo"
 putcmdlog "\002\!cK4C\002 #${hand}# chemail $user $emailinfo"
 putdcc $idx "\002\!cK4C\002 ${user}'s Setting for 'email' is now $emailinfo"
}
...
proc pub_chgreet {nick uhost hand chan rest} { 
 ...
 if {($greetinfo == "") || ($user == "")} {
   puthelp "NOTICE $nick :\002\!cK4C\002 Usage: ${CC}chgreet <new greet>"
   return 0
 }
 if {![validuser $user]} {
   puthelp "NOTICE $nick :\002\!cK4C\002 no such user."
 ...
 if {[lindex $greetinfo 0] == "none"} {
   ...
   putcmdlog "\002\!cK4C\002 #${hand}# chgreet $user $greetinfo"
   puthelp "NOTICE $nick :\002\!cK4C\002 ${user}'s greet msg has been removed."
   return 0
 }
 set greet([string tolower $user]) "$greetinfo"
 putcmdlog "\002\!cK4C\002 #${hand}# chgreet $user $greetinfo"
 puthelp "NOTICE $nick :\002\!cK4C\002 ${user}'s Setting for 'greet' is now $greetinfo"
}
...
proc dcc_chgreet {hand idx arg} { 
 ...
 if {($greetinfo == "") || ($user == "")} {
   putdcc $idx "\002\!cK4C\002 Usage: ${CC}chgreet <new greet>"
   return 0
 }
 if {![validuser $user]} {
   putdcc $idx "\002\!cK4C\002 no such user."
 ...
 if {[lindex $greetinfo 0] == "none"} {
   set greet([string tolower $user]) ""
   putcmdlog "\002\!cK4C\002 #${hand}# chgreet $user $greetinfo"
   putdcc $idx "\002\!cK4C\002 ${user}'s greet msg has been removed."
   return 0
 }
 set greet([string tolower $user]) "$greetinfo"
 putcmdlog "\002\!cK4C\002 #${hand}# chgreet $user $greetinfo"
 putdcc $idx "\002\!cK4C\002 ${user}'s Setting for 'greet' is now $greetinfo"
}
...
proc pub_url {nick uhost hand chan rest} {
 ...
 if {$urlinfo == ""} {
   puthelp "NOTICE $nick :\002\!cK4C\002 Usage: ${CC}url <new url>"
   return 0
 }
 if {[lindex $urlinfo 0] == "none"} {
   set url([string tolower $user]) ""
   putcmdlog "\002\!cK4C\002 #${hand}# url $urlinfo"
   puthelp "NOTICE $nick :\002\!cK4C\002 Your url msg has been removed." 
   return 0
 }
 set url([string tolower $hand]) "$urlinfo"
 putcmdlog "\002\!cK4C\002 #${hand}# url $urlinfo"
 puthelp "NOTICE $nick :\002\!cK4C\002 Setting for 'url' is now $urlinfo"
}
...
proc dcc_url {hand idx arg} {
 ...
 if {$urlinfo == ""} {
   putdcc $idx "\002\!cK4C\002 Usage: .url <new url>"
   return 0
 }
 if {[lindex $urlinfo 0] == "none"} {
   set url([string tolower $hand]) ""
   putcmdlog "\002\!cK4C\002 #${hand}# url $urlinfo"
   putdcc $idx "\002\!cK4C\002 Your url msg has been removed."
   return 0
 }
 set url([string tolower $hand]) "$urlinfo"
 putcmdlog "\002\!cK4C\002 #${hand}# url $urlinfo"
 putdcc $idx "\002\!cK4C\002 Setting for 'url' is now $urlinfo"
}
...
proc pub_churl {nick uhost hand chan rest} { 
 ...
 if {($urlinfo == "") || ($user == "")} {
   puthelp "NOTICE $nick :\002\!cK4C\002 Usage: ${CC}churl <new url>"
   return 0
 }
 if {![validuser $user]} {
   puthelp "NOTICE $nick :\002\!cK4C\002 no such user."
 ...
 if {[lindex $urlinfo 0] == "none"} {
   set url([string tolower $user]) ""
   putcmdlog "\002\!cK4C\002 #${hand}# churl $user $urlinfo"
   puthelp "NOTICE $nick :\002\!cK4C\002 ${user}'s url msg has been removed."
   return 0
 }
 set url([string tolower $user]) "$urlinfo"
 putcmdlog "\002\!cK4C\002 #${hand}# churl $user $urlinfo"
 puthelp "NOTICE $nick :\002\!cK4C\002 ${user}'s Setting for 'url' is now $urlinfo"
}
...
proc dcc_churl {hand idx arg} { 
 ...
 if {($urlinfo == "") || ($user == "")} {
   putdcc $idx "\002\!cK4C\002 Usage: ${CC}churl <new url>"
   return 0
 }
 if {![validuser $user]} {
   putdcc $idx "\002\!cK4C\002 no such user."
 ...
 if {[lindex $urlinfo 0] == "none"} {
   set url($user) ""
   putcmdlog "\002\!cK4C\002 #${hand}# churl $user $urlinfo"
   putdcc $idx "\002\!cK4C\002 ${user}'s url msg has been removed."
   return 0
 }
 set url(${user}) "$urlinfo"
 putcmdlog "\002\!cK4C\002 #${hand}# churl $user $urlinfo"
 putdcc $idx "\002\!cK4C\002 ${user}'s Setting for 'url' is now $urlinfo"
}
...
proc pub_userinfo {nick uhost hand chan rest} {
 ...
 puthelp "NOTICE $nick :\002\!cK4C\002 Information about $user" 
 puthelp "NOTICE $nick :\002\!cK4C\002 Current Time   : [ctime [unixtime]] $timezone"
 if {[validuser $user] == 0} {
   puthelp "NOTICE $nick :\002\!cK4C\002 No such user."
   return 0
 }
 ...
 puthelp "NOTICE $nick :\002\!cK4C\002 Last Online    : $last"
 ...
 if {!$emailyes} {
   if {$email([string tolower $user]) != ""} {  
     puthelp "NOTICE $nick :\002\!cK4C\002 E-Mail Address : $email([string tolower $user])"
   }
 }
 if {!$urlyes} {
   if {$url([string tolower $user]) != ""} {  
     puthelp "NOTICE $nick :\002\!cK4C\002 Web Address    : $url([string tolower $user])"
   }
 }
 if {!$greetyes} {
   if {$greet([string tolower $user]) != ""} {  
     puthelp "NOTICE $nick :\002\!cK4C\002 Greet          : $greet([string tolower $user])"
   }
 }
 if {[getuser $user INFO] != ""} {
   puthelp "NOTICE $nick :\002\!cK4C\002 Info           : [getuser $user INFO]"
 }
}
...
proc dcc_userinfo {hand idx arg} {
 ...
 if {$user == ""} {set user $hand}
 putdcc $idx "\002\!cK4C\002 Information about $user"
 putdcc $idx "\002\!cK4C\002 Current Time   : [ctime [unixtime]] $timezone"
 if {[validuser $user] == 0} {
   putdcc $idx "\002\!cK4C\002 No such user."
   return 0
 }
 ...
 putdcc $idx "\002\!cK4C\002 Last Online    : $last"
 set emailyes 0;set urlyes 0;set greetyes 0
 if {![info exists url([string tolower $user])]} {set urlyes 1}
 if {![info exists email([string tolower $user])]} {set emailyes 1}
 ...
 if {!$emailyes} {
   if {$email([string tolower $user]) != ""} {
     putdcc $idx "\002\!cK4C\002 E-Mail Address : $email([string tolower $user])"
   }
 }
 if {!$urlyes} {
   if {$url([string tolower $user]) != ""} {
     putdcc $idx "\002\!cK4C\002 Web Address    : $url([string tolower $user])"
   }
 }
 if {!$greetyes} {
   if {$greet([string tolower $user]) != ""} {
     putdcc $idx "\002\!cK4C\002 Greet          : $greet([string tolower $user])"
   }
 }
 if {[getuser $user INFO] != ""} {
   putdcc $idx "\002\!cK4C\002 Info           : [getuser $user INFO]"
 }
}
...
set handle [lindex $rest 0]
 if {$rest == ""} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Usage: ${CC}seen <handle>"
   return 0
 }
 if {[validuser $handle] == 0} {
  puthelp "NOTICE $nick :\002\!cK4C\002 No such user in my userlist."
  return 0
 }
 if {[string tolower $handle] == [string tolower $nick]} {
  puthelp "NOTICE $nick :\002\!cK4C\002 You are here."
  return 0
 }
 if {[onchan $handle $chan] == 1} {
  puthelp "NOTICE $nick :\002\!cK4C\002 $handle is currently on $chan."
  return 0
 }
 set lastseen [getuser $handle LASTON]
 if {$lastseen == ""} {puthelp "NOTICE $nick :\002\!cK4C\002 $handle was never here";return 0}
  set lastseen [lindex $lastseen 0]
	...
	puthelp "NOTICE $nick :\002\!cK4C\002 $nick, I last saw $handle $output ago"
}
## pub cmd seen -- stop
...
proc msg_auth {nick uhost hand rest} {
 ...
 if {$pw == ""} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Usage: /msg $botnick auth <password>"
  return 0
 }
 if {[matchattr $hand Q] == 1} {
  puthelp "NOTICE $nick :\002\!cK4C\002 You are already Authenticated."
  return 0
 }
 set ch [passwdok $hand ""]
 if {$ch == 1} {
  puthelp "NOTICE $nick :\002\!cK4C\002 No password set. Type /msg $botnick pass <password>" 
  return 0
 }
 if {[passwdok $hand $pw] == 1} {
  chattr $hand +Q
  putcmdlog "\002\!cK4C\002 #$hand# auth ..."
  puthelp "NOTICE $nick :\002\!cK4C\002 Authentication successful!"
 }
 if {[passwdok $hand $pw] == 0} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Authentication failed!"
 }
}
## msg cmd auth -- stop
...
proc msg_deauth {nick uhost hand rest} {
 ...
 if {[matchattr $hand Q] == 0} {
  puthelp "NOTICE $nick :\002\!cK4C\002 You never authenticated."
  return 0
 }
 if {[passwdok $hand $rest] == 1} {
  chattr $hand -Q
  putcmdlog "\002\!cK4C\002 #$hand# deauth ..."
  puthelp "NOTICE $nick :\002\!cK4C\002 DeAuthentication successful!"
 }
 if {[passwdok $hand $rest] == 0} {
  puthelp "NOTICE $nick :\002\!cK4C\002 DeAuthentication failed!"
 }
}
## msg cmd deauth -- stop
...
proc sign_deauth {nick uhost hand chan rest} { 
 if {[matchattr $hand Q] == 1} {
  chattr $hand -Q
  putlog "\002\!cK4C\002 $nick has signed off, automatic deauthentication."
 }
 if {[matchattr $hand Q] == 0} {
  return 0
 }
...
proc part_deauth {nick uhost hand chan} {
  if {[matchattr $hand Q] == 1} {
  chattr $hand -Q
  putlog "\002\!cK4C\002 $nick has parted $chan, automatic deauthentication."
 }
 if {[matchattr $hand Q] == 0} {
  return 0
 }
...
proc pub_about {nick uhost hand chan rest} {
 global vers
 putcmdlog "\002\!cK4C\002 #$hand# about cKc.tcl"
 puthelp "NOTICE $nick :\002\!cK4C\002 cKc.tcl $vers by royflash <royflash@royflash.net>"
 puthelp "NOTICE $nick :\002\!cK4C\002 Kaili TechNoloGieS Internal use only for TadulakO Crew"
 puthelp "NOTICE $nick :\002\!cK4C\002 Copyright (c)2002 TadulakO Crew"
}
...
proc dcc_about {hand idx args} {
 global vers
 putcmdlog "\002\!cK4C\002 #$hand# about cKc.tcl"
 putdcc $idx "\002\!cK4C\002 cKc.tcl $vers by royflash <royflash@royflash.net>"
 putdcc $idx "\002\!cK4C\002 Kaili TechNoloGieS Internal use only for TadulakO Crew"
 putdcc $idx "\002\!cK4C\002 Copyright (c)2002 TadulakO Crew"
}
## dcc cmd about - stop

## public cmd version -- start
proc pub_version {nick uhost hand chan rest} {
 putcmdlog "\002\!cK4C\002 #$hand# version"
 global vers
 puthelp "NOTICE $nick :\002\!cK4C\002 cKc.tcl $vers (c)2002 TadulakO Crew"
}
...
proc dcc_version {hand idx args} {
 global vers
 putcmdlog "\002\!cK4C\002 #$hand# version"
 putdcc $idx "\002\!cK4C\002 cKc.tcl $vers (c)2002 TadulakO Crew"
}
## dcc cmd version -- stop

## public cmd help -- start
proc pub_help {nick uhost hand chan rest} {
 puthelp "NOTICE $nick :\002\!cK4C\002 help is only available via dcc chat."
} 
## public cmd help -- stop

## public cmd cKchelp -- start
proc pub_cKchelp {nick uhost hand chan rest} {
 puthelp "NOTICE $nick :\002\!cK4C\002 cKchelp is only available via dcc chat."
}
...
proc dcc_cKchelp {hand idx args} {
 ...
 set tn "\002\!cK4C\002"
 set args [lindex $args 0]
 global CC NC
 if {$args == ""} {
  putdcc $idx "$tn !cK4C ${vers} by royflash <royflash@royflash.net>"
...
proc dcc_wi {hand idx arg} {
 global botnick
 if {$arg == ""} {
   putdcc $idx "\002\!cK4C\002 Usage: whois <handle>"
   return 0
 }
...
set channel [lindex $args 0]
 if {[validchan $channel]} {
  ...
  putdcc $idx "\002\!cK4C\002 Usage: mub <#channel>"
 }
}
## dcc cmd mub -- stop
...
set channel [lindex $args 0]
 if {[validchan $channel]} {
  ...
  putdcc $idx "\002\!cK4C\002 Usage: massunban <#channel>"
 }
}
...
proc pub_dccstat {nick uhost hand chan rest} {
 set socksp "    ";set usersp "         ";set hostsp "                 "
   puthelp "NOTICE $nick :\002\!cK4C\002 SOCK NICK      HOST              TYPE"
   puthelp "NOTICE $nick :\002\!cK4C\002 ---- --------- ----------------- ----"
...
#   set info [lsort -integer [lindex $info 0]] [lrange $info 1 end]
   ...
   puthelp "NOTICE $nick :\002\!cK4C\002 $sock $user $host $type"
   putcmdlog "\002\!cK4C\002 #$hand# dccstat"
 }
}
...
proc pub_-chrec {nick uhost hand chan rest} {
 puthelp "NOTICE $nick :\002\!cK4C\002 -chrec is only available via dcc chat."
}
...
proc pub_debug {nick uhost hand chan rest} {
 puthelp "NOTICE $nick :\002\!cK4C\002 debug is only available via dcc chat."
}
...
proc pub_botattr {nick uhost hand channel rest} {
 ...
 if {($bot == "") || ($bflags == "")} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Usage: ${CC}botattr <bot> <flags> \[channel\]"
  return 0
 }
 if {[validuser $bot] == 0} {
  puthelp "NOTICE $nick :\002\!cK4C\002 No such bot!"
  return 0
 }
 if {[matchattr $bot b] == 0} {
  puthelp "NOTICE $nick :\002\!cK4C\002 $bot is not a bot"
  return 0
 }
 if {$chan != ""} {
  if {[validchan $chan]} {
   putcmdlog "\002\!cK4C\002 #$hand# botattr $bot $bflags $chan"
   ...
   puthelp "NOTICE $nick :\002\!cK4C\002 botattr $bot \[${bflags}\] $chan"
   puthelp "NOTICE $nick :\002\!cK4C\002 Global Flags for $bot are \[${globalflags}\]"   
   if {$chanflags != "-"} {
    puthelp "NOTICE $nick :\002\!cK4C\002 Channel \"${chan}\" Flags for $bot are \[${chanflags}\]"
   } else {
    puthelp "NOTICE $nick :\002\!cK4C\002 $bot does not have any channel specific flags."
   }
  } else {
   puthelp "NOTICE $nick :\002\!cK4C\002 $chan is not a valid channel"
  }
 } else {
  putcmdlog "\002\!cK4C\002 #$hand# botattr $bot $bflags"
  botattr $bot $bflags
  set bflags [getuser $bot BOTFL]
  puthelp "NOTICE $nick :\002\!cK4C\002 botattr $bot \[${bflags}\]"
  puthelp "NOTICE $nick :\002\!cK4C\002 Global Flags for $bot are now \[${bflags}\]"
 }
}
...
proc pub_-chan {nick uhost hand chan rest} {
 ...
 if {$channel == ""} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Usage: ${CC}+chan <#channel>"
  return 0
 }
 ...
 if {[validchan $channel]} {
  putcmdlog "\002\!cK4C\002 #$hand# -chan $channel"
  channel remove $channel
  puthelp "NOTICE $nick :\002\!cK4C\002 Channel $channel removed from the bot."
  puthelp "NOTICE $nick :\002\!cK4C\002 This includes any channel specific bans you set."
 } else {
  puthelp "NOTICE $nick :\002\!cK4C\002 That channel doesnt exist!"
 }
}
## public cmd -chan -- stop
...
proc pub_+chan {nick uhost hand chan rest} {
 ...
 if {$channel == ""} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Usage: ${CC}+chan <#channel> \[option-list\]"
  return 0
 }
 if {[validchan $channel]} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Your already in $channel"
 } else {
  if {[string first # $channel]!=0} {
   set channel "#$channel"
  }
 putcmdlog "\002\!cK4C\002 #$hand# +chan $channel $options"
...
proc pub_binds {nick uhost hand chan rest} {
 puthelp "NOTICE $nick :\002\!cK4C\002 binds is only available via dcc chat."
}
## public cmd binds -- stop

## public cmd reset -- start
proc pub_reset {nick uhost hand chan rest} {
 puthelp "NOTICE $nick :\002\!cK4C\002 reset is only available via dcc chat."
}
## public cmd reset -- stop

## public cmd banner -- start
proc pub_banner {nick uhost hand chan rest} {
 puthelp "NOTICE $nick :\002\!cK4C\002 banner is only available via dcc chat."
}
...
proc pub_resetbans {nick uhost hand channel rest} {
 ...
 if {$chan != ""} {
  if {[validchan $chan]} {
   ...
   putserv "MODE $chan +b"
   putcmdlog "\002\!cK4C\002 #$hand# (${chan}) resetbans"
   puthelp "NOTICE $nick :\002\!cK4C\002 Resetting bans on $chan..."
   return 0
  } else {
   puthelp "NOTICE $nick :\002\!cK4C\002 $chan is an invalid channel."
   return 0
  }
 }
 if {$chan == ""} {
  foreach ban [banlist] {
   foreach i [channels] {
    ...
    puthelp "NOTICE $nick :\002\!cK4C\002 Resetting bans on $i"
   }
  }
  foreach x [channels] {
   putserv "MODE $x +b"
  }
  putcmdlog "\002\!cK4C\002 #$hand# resetbans"
 }
}
...
proc pub_flush {nick uhost hand chan rest} {
 puthelp "NOTICE $nick :\002\!cK4C\002 flush is only available via dcc chat."
}
## public cmd flush -- stop

## public cmd set -- start
proc pub_set {nick uhost hand chan rest} {
 puthelp "NOTICE $nick :\002\!cK4C\002 set is only available via dcc chat."
}
## public cmd set -- stop
...
proc pub_chanload {nick uhost hand chan rest} {
 ...
 putcmdlog "\002\!cK4C\002 #$hand# chanload"
 loadchannels
 puthelp "NOTICE $nick :\002\!cK4C\002 Reloading all dynamic channel settings."
}
...
proc pub_chansave {nick uhost hand chan rest} {
 ...
 putcmdlog "\002\!cK4C\002 #$hand# chansave"
 puthelp "NOTICE $nick :\002\!cK4C\002 Saving all dynamic channel settings."
 savechannels
 puthelp "NOTICE $nick :\002\!cK4C\002 Writing channel file ..."
}
...
proc pub_chanset {nick uhost hand chan rest} {
 ...
 set options [lindex $rest 1]
 if {($channel == "") || ($options == "")} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Usage: ${CC}chanset #<channel> <option...>"
  return 0
 }
 if {[validchan $channel]} {
  putcmdlog "\002\!cK4C\002 #$hand# chanset $channel $options"
  channel set $channel $options
  puthelp "NOTICE $nick :\002\!cK4C\002 Successfully set modes \{ $options \} on $channel"
  puthelp "NOTICE $nick :\002\!cK4C\002 Changes to $channel are not permanent."
 } else {
  puthelp "NOTICE $nick :\002\!cK4C\002 No such channel."
 }
}
...
proc pub_restart {nick uhost hand chan rest} {
 ...
 if {[matchattr $hand Q] == 0} {
  ...
  utimer 1 restart
  putcmdlog "\002\!cK4C\002 #${hand}# restart"
  puthelp "NOTICE $nick :\002\!cK4C\002 Writing user file... Writing channel file ... Restarting ..."
}
...
proc pub_rehash {nick uhost hand chan rest} {
 if {[matchattr $hand Q] == 0} {
  ...
  utimer 1 rehash
  putcmdlog "\002\!cK4C\002 #${hand}# rehash"
  puthelp "NOTICE $nick :\002\!cK4C\002 Writing user & channel file... Rehashing.. Userfile loaded, unpacking..."
}
## public cmd rehash -- stop

## public cmd relay -- start
proc pub_relay {nick uhost hand chan rest} {
 puthelp "NOTICE $nick :\002\!cK4C\002 relay is only available via dcc chat."
}
...
proc pub_chaninfo {nick uhost hand chan rest} {
 global CC
 if {$rest == ""} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Usage: ${CC}chaninfo <#channel>"
  return 0
 }
 if {[validchan $rest]} {
  set em [lindex [channel info $rest] 0]
  putcmdlog "\002\!cK4C\002 #$hand# chaninfo $rest"
  puthelp "NOTICE $nick :\002\!cK4C\002 Settings for static channel $rest"
  set em [lindex [channel info $rest] 0]
  puthelp "NOTICE $nick :\002\!cK4C\002 Protect modes (chanmode): $em"
 if {[lindex [channel info $rest] 1] == "0"} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Idle Kick after (idle-kick): DONT!"
 } else {
  puthelp "NOTICE $nick :\002\!cK4C\002 Idle Kick after (idle-kick): [lindex [channel info $rest] 1] min"
 } 
  puthelp "NOTICE $nick :\002\!cK4C\002 Other modes:" 
  puthelp "NOTICE $nick :\002\!cK4C\002      [lindex [channel info $rest] 12]  [lindex [channel info $rest] 13]  [lindex [channel info $rest] 14]  [lindex [channel info $rest] 15]"
  puthelp "NOTICE $nick :\002\!cK4C\002      [lindex [channel info $rest] 16]     [lindex [channel info $rest] 17]        [lindex [channel info $rest] 18]        [lindex [channel info $rest] 19]"
  puthelp "NOTICE $nick :\002\!cK4C\002      [lindex [channel info $rest] 20]  [lindex [channel info $rest] 21]  [lindex [channel info $rest] 22]      [lindex [channel info $rest] 23]"
  puthelp "NOTICE $nick :\002\!cK4C\002      [lindex [channel info $rest] 24]      [lindex [channel info $rest] 25]   [lindex [channel info $rest] 26]"
  ...
  puthelp "NOTICE $nick :\002\!cK4C\002 flood settings: chan: $ichan  ctcp: $ictcp  join: $ijoin  kick: $ikick  deop: $ideop"    
 } else { 
  puthelp "NOTICE $nick :\002\!cK4C\002 No such channel defined."
 }
}
...
proc pub_status {nick uhost hand chan rest} {
 ...
 putcmdlog "\002\!cK4C\002 #$hand# status"
 set vers [lindex $version 0]
 set users [countusers]
 regsub -all " " [channels] ", " chans
 puthelp "NOTICE $nick :\002\!cK4C\002 I am $botnick, running eggdrop v${vers}: $users users"
 puthelp "NOTICE $nick :\002\!cK4C\002 Running on [exec uname -sr]"
 puthelp "NOTICE $nick :\002\!cK4C\002 Server $server"
 ...
 puthelp "NOTICE $nick :\002\!cK4C\002 Online for $output  (background)  CPU $cpu"  
 puthelp "NOTICE $nick :\002\!cK4C\002 Admin: $admin"
 puthelp "NOTICE $nick :\002\!cK4C\002     DCC file path: ${files-path}"
 puthelp "NOTICE $nick :\002\!cK4C\002         incoming: ${incoming-path}"
 puthelp "NOTICE $nick :\002\!cK4C\002        max users is ${max-file-users}"
 puthelp "NOTICE $nick :\002\!cK4C\002     DCC max file size: ${max-filesize}k"
 puthelp "NOTICE $nick :\002\!cK4C\002 Channels: $chans"
 puthelp "NOTICE $nick :\002\!cK4C\002 Server $server" 
 foreach x [channels] {
  set ch [llength [chanlist $x]]
  set em [lindex [channel info $x] 0]
  puthelp "NOTICE $nick :\002\!cK4C\002 $x :  $ch members, enforcing \"${em}\""
 }
}
...
proc pub_boot {nick uhost hand chan rest} {
 puthelp "NOTICE $nick :\002\!cK4C\002 Access denied, people should know who is booting them."
}
## public cmd boot -- stop

## public cmd assoc -- start
proc pub_assoc {nick uhost hand chan rest} {
 puthelp "NOTICE $nick :\002\!cK4C\002 assoc is only available via dcc chat."
}
## public cmd assoc -- stop

## public cmd chbotattr -- start
proc pub_chbotattr {nick uhost hand chan rest} {
 puthelp "NOTICE $nick :\002\!cK4C\002 See botattr command."
}
...
proc pub_unlink {nick uhost hand chan rest} {
 ...
 if {$rest == ""} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Usage: ${CC}unlink <bot>"
  return 0
 }
 if {([validuser $rest] == 0) || ([matchattr $rest b] == 0)} {
  puthelp "NOTICE $nick :\002\!cK4C\002 $rest is not in my userlist as a bot."
  return 0
 }
 if {[lsearch -exact [string tolower [bots]] [string tolower $rest]] == -1} {
  puthelp "NOTICE $nick :\002\!cK4C\002 $rest is not linked on the botnet."
  return 0
 }
 if {[lsearch -exact [string tolower [bots]] [string tolower $rest]] > -1} {
  putcmdlog "\002\!cK4C\002 #$hand# unlink $rest"
  unlink $rest
  puthelp "NOTICE $nick :\002\!cK4C\002 Breaking link with $rest"
 }
}
...
proc pub_link {nick uhost hand chan rest} {
 ...
 if {$rest == ""} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Usage: ${CC}link <bot>"
  return 0
 }
 if {([validuser $rest] == 0) || ([matchattr $rest b] == 0)} {
  puthelp "NOTICE $nick :\002\!cK4C\002 $rest is not in my userlist as a bot."
 ...
 if {[lsearch -exact [string tolower [bots]] [string tolower $rest]] > -1} {
  puthelp "NOTICE $nick :\002\!cK4C\002 $rest is already linked on the botnet."
  return 0
 }
 if {[lsearch -exact [string tolower [bots]] [string tolower $rest]] == -1} {
  putcmdlog "\002\!cK4C\002 #$hand# link $rest"
  link $rest
  puthelp "NOTICE $nick :\002\!cK4C\002 Linking to $rest at [getaddr $rest]"
 }
}
## public cmd link -- end
...
proc pub_su {nick uhost hand chan rest} {
 puthelp "NOTICE $nick :\002\!cK4C\002 su is only available via dcc chat."
}
## public cmd strip -- start
proc pub_strip {nick uhost hand chan rest} {
 puthelp "NOTICE $nick :\002\!cK4C\002 strip is only available via dcc chat."
}
## public cmd strip -- stop

## public cmd page -- start
proc pub_page {nick uhost hand chan rest} {
 puthelp "NOTICE $nick :\002\!cK4C\002 page is only available via dcc chat."
}
...
proc pub_filestats {nick uhost hand chan rest} {
 global CC
 if {$rest == ""} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Usage: ${CC}filestats <handle>"
  return 0
 }
 if {[validuser $rest] == 0} {
  puthelp "NOTICE $nick :\002\!cK4C\002 $rest is not in my userlist."
  return 0
 }
 if {[validuser $rest] == 1} {
  ...
  putcmdlog "\002\!cK4C\002 #$hand# filestats $rest"
 ...
 puthelp "NOTICE $nick :\002\!cK4C\002 \037${rest}'s filestats\037"
 puthelp "NOTICE $nick :\002\!cK4C\002   uploads:${main}${nul} /${s}${tul}k"
 puthelp "NOTICE $nick :\002\!cK4C\002 downloads:${main}${ndl} /${s}${tdl}k"
 }
}
...
proc pub_unstick {nick uhost hand chan rest} {
 puthelp "NOTICE $nick :\002\!cK4C\002 unstick is only available via dcc chat."
}
## public cmd unstick -- stop

## public cmd stick -- start
proc pub_stick {nick uhost hand chan rest} {
 puthelp "NOTICE $nick :\002\!cK4C\002 stick is only available via dcc chat."
}
## public cmd stick -- stop

## public cmd fixcodes -- start
proc pub_fixcodes {nick uhost hand chan rest} {
 puthelp "NOTICE $nick :\002\!cK4C\002 fixcodes is only available via dcc chat."
}
## public cmd fixcodes -- stop

## public cmd trace -- start
proc pub_trace {nick uhost hand chan rest} {
 puthelp "NOTICE $nick :\002\!cK4C\002 trace is only available via dcc chat."
}
## public cmd trace -- stop

## public cmd botinfo -- start
proc pub_botinfo {nick uhost hand chan rest} {
 puthelp "NOTICE $nick :\002\!cK4C\002 botinfo is only available via dcc chat."
}
...
global CC botnick
 if {[matchattr $hand Q] == 0} {
  puthelp "NOTICE $nick :\002\!cK4C\002 This command requires you to authenticate. /msg $botnick auth <password>"
  return 0
 }
 set botname [lindex $rest 0]
 set changes [lindex $rest 1]
 if {($botname == "") || ($changes == "")} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Usage: ${CC}chaddr <bot> <address:port#\[relay-port#\]>"
  return 0
 }
 ...
 if {[validuser $botname] == 0} {
  puthelp "NOTICE $nick :\002\!cK4C\002 There is no such bot in the userlist." 
  return 0
 }
 if {[matchattr $botname b] == 0} {
  puthelp "NOTICE $nick :\002\!cK4C\002 $rest is not a bot."
  return 0
 }
 botattr $botname $changes
 set oldaddy [getuser $botname BOTADDR]
 set oldaddy [lindex $oldaddy 0]:[lindex $oldaddy 1]/[lindex $oldaddy 2]
 puthelp "NOTICE $nick :\002\!cK4C\002 Changed ${botname}'s Address from \[${oldaddy}\] to \[$changes\]"
}
...
proc pub_rollcall {nick uhost hand chan rest} {
 ...
 set cmdchar $CC
 putlog "\002\!cK4C\002 <<$nick>> !$hand! rollcall"
 puthelp "NOTICE $nick :\002\!cK4C\002 I am ${botnick}, running eggdrop v${botvers}"
 puthelp "NOTICE $nick :\002\!cK4C\002 My Command Charactor is \[${CC}\]"
}
...
proc dcc_access {hand idx rest} {
 ...
 if {$who == ""} {
  putdcc $idx "\002\!cK4C\002 Usage: .access <nick | me>"
  return 0
 }
 if {$who == "me"} {
  if {$chan != ""} { 
   if {[validchan $chan]} {
    ...
    putlog "\002\!cK4C\002 !$hand! access $swho $chan"
    if {$cfflags == "-"} {
     putdcc $idx "\002\!cK4C\002 You do not have any channel specific flags on ${chan}."
     return 0
    } else {
     putdcc $idx "\002\!cK4C\002 Your access is \[${cfflags}\] on ${chan}."
     return 0
    }
   } else {
    putdcc $idx "\002\!cK4C\002 $chan is not a valid channel."
    return 0
   }
  }
  if {$chan == ""} {
   ...
   putlog "\002\!cK4C\002 !$hand! access $mwho"
   putdcc $idx "\002\!cK4C\002 Your access is \[${mflags}\]"
   return 0
  }
 }
 if {[validuser $who] == 1} {
  if {$chan != ""} {
   if {[validchan $chan]} {
    ...
    set nflags [string trimleft $cflags "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ"]
    set cfflags [string trim $nflags "|"]
    putlog "\002\!cK4C\002 !$hand! access $who $chan"
    if {$cfflags == "-"} {
     putdcc $idx "\002\!cK4C\002 You do not have any channel specific flags on ${chan}."
     return 0
    } else {
     putdcc $idx "\002\!cK4C\002 ${who}'s access is \[${cfflags}\] on ${chan}."
     return 0
    }
   } else {
    putdcc $idx "\002\!cK4C\002 $chan is not a valid channel."
  ...
  if {$chan == ""} {
   ...
   putlog "\002\!cK4C\002 !$hand! access $who"
   putdcc $idx "\002\!cK4C\002 ${who}'s access is \[${flags}\]"
   return 0
  }
 }
 if {[validuser $who] == 0} {
...
proc pub_access {nick uhost hand chan rest} {
 ...
 set chan [lindex $rest 1]
 if {$who == ""} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Usage: ${CC}access <nick | me>"
  return 0
 }
 if {$who == "me"} {
  if {$chan != ""} {
   if {[validchan $chan]} {
    ...
    putlog "\002\!cK4C\002 !$hand! access $swho $chan"
    if {$cfflags == "-"} {
     puthelp "NOTICE $nick :\002\!cK4C\002 You do not have any channel specific flags on ${chan}."
     return 0
    } else {
     puthelp "NOTICE $nick :\002\!cK4C\002 Your access is \[${cfflags}\] on ${chan}."
     return 0
    }
   } else {
    puthelp "NOTICE $nick :\002\!cK4C\002 $chan is not a valid channel."
  ...
  if {$chan == ""} {
   ...
   set mflags [chattr $mwho]
   putlog "\002\!cK4C\002 !$hand! access $mwho"
   puthelp "NOTICE $nick :\002\!cK4C\002 Your access is \[${mflags}\]"
   return 0
  }
 }
 if {[validuser $who] == 1} {
  if {$chan != ""} {
   if {[validchan $chan]} {
    ...
    putlog "\002\!cK4C\002 !$hand! access $who $chan"
    if {$cfflags == "-"} {
     puthelp "NOTICE $nick :\002\!cK4C\002 ${who} does not have any channel specific flags on ${chan}."
     return 0
    } else {
     puthelp "NOTICE $nick :\002\!cK4C\002 ${who}'s access is \[${cfflags}\] on ${chan}."
     return 0
    }
   } else {
    puthelp "NOTICE $nick :\002\!cK4C\002 $chan is not a valid channel."
  ...
  if {$chan == ""} {
   set flags [chattr $who]
   putlog "\002\!cK4C\002 !$hand! access $who"
   puthelp "NOTICE $nick :\002\!cK4C\002 ${who}'s access is \[${flags}\]"
   return 0
  }
 }
 if {[validuser $who] == 0} {
...
proc pub_botnick {nick uhost hand chan rest} {
 ...
 set bot [lindex $rest 0]
 if {$bot==""} {
  puthelp "NOTICE $nick :\002\!cK4C\002 ${CC}botnick <new botnick>."
  return 0
 }
 putcmdlog "\002\!cK4C\002 #$hand# botnick $bot"
 putserv "NICK $bot"
}
...
proc dcc_botnick {hand idx rest} {
 set bot [lindex $rest 0]
 if {$bot==""} {
  puthelp "NOTICE $nick :\002\!cK4C\002 .botnick <new botnick>."
  return 0
 }
 putcmdlog "\002\!cK4C\002 #$hand# botnick $bot"
 putserv "NICK $bot"
...
proc pub_jump {nick uhost hand chan rest} {
 ...
 if {$server == ""} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Usage: jump <server> \[port\] \[password\]"
  return 0
 }
 set port [lindex $rest 1]
 if {$port == ""} {set port "6667"}
 set password [lindex $rest 2]
 putcmdlog "\002\!cK4C\002 #$hand# jump $server $port $password"
...
proc pub_die {nick uhost hand channel rest} {
 ...
 putcmdlog "\002\!cK4C\002 #$hand# quit $rest"
 if {$rest == ""} {set rest "requested!"} 
 foreach x [userlist] {
  chattr $x -Q
 }
...
proc pub_ban  {nick uhost hand channel rest} {
 ...
 if {[botisop $channel]==1} {
  if {$rest == ""} {
   puthelp "NOTICE $nick :\002\!cK4C\002 Usage: ${CC}ban <nick> \[reason\]"
   return 0
  }
  if {$rest!=""} {
   set handle [lindex $rest 0]
   ...
   if {![onchan $handle $channel]} {
    puthelp "NOTICE $nick :\002\!cK4C\002 $handle is not on the channel."
    return 0
   }
   if {[onchansplit $handle $channel]} {
    puthelp "NOTICE $nick :\002\!cK4C\002 $handle is currently net-split."
    return 0
   }
   if {[string tolower $handle] == [string tolower $botnick]} {
    putserv "KICK $channel $nick :!cK4C-v7a7\[ $botnick 4!KiCk 7\]"
    return 0
   }    
   if {$reason == ""} { 
   ...
   switch -exact  $options {
     perm {
             ...
             putlog "\002\!cK4C\002 <<$nick>> !$hand! ban $channel $hostmask $options $reason"
             return 0
           }
     min {
             if {[val [lindex $reason 1]] == ""} {
               puthelp "NOTICE $nick :\002\!cK4C\002 Error, invalid time period"
               return 0
             }
 ...
 if {[isop $botnick $channel]!=1} {
  puthelp "NOTICE $nick :\002\!cK4C\002 I am not oped"
 }
}
## public cmd ban -- stop
...
proc pub_reload {nick uhost hand chan rest} {
 ...
 reload
 putcmdlog "\002\!cK4C\002 #$hand# reload"
 puthelp "NOTICE $nick :\002\!cK4C\002 Reloading user file..."
}
## public cmd restart -- stop
...
proc pub_ignores {nick uhost hand chan rest} {
 ...
 puthelp "NOTICE $nick :\002\!cK4C\002 Currently ignoring:$iglist"
 putlog "\002\!cK4C\002 <<$nick>> !$hand! ignores"
 return 0
}
...
proc pub_-ignore {nick uhost hand chan rest} {
 ...
 if {$hostmask == ""} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Usage: ${CC}-ignore <hostmask>"
  return 0
 }
 if {[isignore $hostmask] == 0} {
  puthelp "NOTICE $nick :\002\!cK4C\002 $hostmask is not on my ignore list."
  return 0
 }
 if {[isignore $hostmask] == 1} {
  putcmdlog "\002\!cK4C\002 #$hand# -ignore $hostmask"
  killignore $hostmask
  puthelp "NOTICE $nick :\002\!cK4C\002 No longer ignoring \[${hostmask}\]"
  save
 }
}
...
proc pub_+ignore {nick uhost hand chan rest} {
 ...
 if {$hostmask == ""} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Usage: ${CC}+ignore <hostmask> \[comment\]"
  return 0
 }
 if {[isignore $hostmask] == 1} {
  puthelp "NOTICE $nick :\002\!cK4C\002 $hostmask is alreay set on ignore."
  return 0
 }
 if {[isignore $hostmask] == 0} {
  putcmdlog "\002\!cK4C\002 #$hand# +ignore $hostmask"
  newignore $hostmask $nick $comment 0
  puthelp "NOTICE $nick :\002\!cK4C\002 Now ignoring \[${hostmask}\]"
  save
 }
}
## public cmd +ignore -- stop
...
proc pub_comment {nick uhost hand chan rest} {
 ...
 if {($comment == "")} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Usage: ${CC}comment <new comment>"
  return 0
 }
  putcmdlog "\002\!cK4C\002 #$hand# comment $comment"
  setuser $hand comment $comment
  puthelp "NOTICE $nick :\002\!cK4C\002 Added comment \[${comment}\]"
}
...
proc pub_chnick {nick uhost hand chan rest} {
 ...
 if {($old == "") || ($new == "")} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Usage: ${CC}chnick <old nick> <new nick>"
  return 0
 }
 if {[validuser $old]==0} {
  puthelp "NOTICE $nick :\002\!cK4C\002 No such user."
 ...
 if {([matchattr $old n] == 1)} {
  puthelp "NOTICE $nick :\002\!cK4C\002 cannot change the bot owner's nick"
  return 0
 }
 if {[validuser $old]==1} {
  putcmdlog "\002\!cK4C\002 #$hand# chnick $old $new"
  chnick $old $new
  puthelp "NOTICE $nick :\002\!cK4C\002 Changed partyline nick from \[${old}\] to \[${new}\]"
 }
}
...
proc pub_chinfo {nick uhost hand chan rest} {
 ...
 if {($who == "") || ($info == "")} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Usage: ${CC}chinfo <nick> <info>"
  return 0
 }
 if {[validuser $who]==0} {
  puthelp "NOTICE $nick :\002\!cK4C\002 No such user."
 ...
 if {[validuser $who]==1} {
  putcmdlog "\002\!cK4C\002 #$hand# chinfo $who $info"
  setuser $who info $info
  puthelp "NOTICE $nick :\002\!cK4C\002 Added info \[${info}\] to $who."
 }
}
...
proc pub_chcomment {nick uhost hand chan rest} {
 global CC botnick
 if {[matchattr $hand Q] == 0} {
  puthelp "NOTICE $nick :\002\!cK4C\002 This command requires you to authenticate yourself. Please /msg $botn$
  return 0
 }
 set who [lindex $rest 0]
 set comment [lrange $rest 1 end]
 if {($who == "") || ($comment == "")} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Usage: ${CC}chcomment <nick> <new comment>"
  return 0
 }
 if {[validuser $who]==0} {
  puthelp "NOTICE $nick :\002\!cK4C\002 No such user."
 ...
 if {[validuser $who]==1} {
  putcmdlog "\002\!cK4C\002 #$hand# chcomment $who $comment"
  setuser $who comment $comment
  puthelp "NOTICE $nick :\002\!cK4C\002 Added info \[${comment}\] to $who."
 }
}
...
proc pub_chemail {nick uhost hand chan rest} {
 global CC botnick
# puthelp "NOTICE $nick :\002\!cK4C\002 This command is only available via dcc chat"
# return 0
 if {[matchattr $hand Q] == 0} {
  puthelp "NOTICE $nick :\002\!cK4C\002 This command requires you to authenticate yourself. Please /msg $botnick auth <password>"
  return 0
 ...
 if {($who == "") || ($email == "")} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Usage: ${CC}chemail <nick> <email>"
  return 0
 }
 if {[validuser $who]==0} {
  puthelp "NOTICE $nick :\002\!cK4C\002 No such user."
 ...
 if {[validuser $who]==1} {
  putcmdlog "\002\!cK4C\002 #$hand# chemail $who $email"
  setuser $who email $email
  puthelp "NOTICE $nick :\002\!cK4C\002 Added email address \[${email}\] to $who."
 }
}
...
proc pub_chpass {nick chan uhost hand rest} {
 global CC
 puthelp "NOTICE $nick :\002\!cK4C\002 Can only be changed via dcc chat."
}
...
proc pub_me {nick uhost hand channel rest} {
 global CC
 if {$rest == ""} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Usage ${CC}me <msg>"
  return 0
 }
 putlog "\002\!cK4C\002 <<$nick>> !$hand! me $rest"
...
proc pub_save {nick uhost hand channel rest} {
 ...
 putcmdlog "\002\!cK4C\002 #$hand# save"
 save
 puthelp "NOTICE $nick :\002\!cK4C\002 Writing channel & user file ..."
}
...
proc pub_chattr {nick uhost hand channel rest} {
 ...
 set chan [lindex $rest 2]
 if {$ownern==""} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Usage: ${CC}chattr <nick> <flags>"
  return 0
 }
 ...
 if {([matchattr $ownern n] == 1) && ([matchattr $nick n] == 0)} {
  puthelp "NOTICE $nick :\002\!cK4C\002 You do not have access to change ${ownern}'s flags."
 }
 if {[matchattr $nick n] == 1} {
  if {$chan != ""} {
   if {[validchan $chan]} {
    putcmdlog "\002\!cK4C\002 #$hand# chattr $ownern $flagss $chan"
    ...
    set chanflags [string trim $chanflags "|"]
    set globalflags [chattr $ownern]
    puthelp "NOTICE $nick :\002\!cK4C\002 chattr $ownern \[${flagss}\] $chan"
    puthelp "NOTICE $nick :\002\!cK4C\002 Global Flags for $ownern are \[${globalflags}\]"
    if {$chanflags != "-"} {
     puthelp "NOTICE $nick :\002\!cK4C\002 Channel \"${chan}\" Flags for $ownern are \[${chanflags}\]"
    } else {
     puthelp "NOTICE $nick :\002\!cK4C\002 $ownern does not have any channel specific flags on ${chan}."
    }
   } else {
    puthelp "NOTICE $nick :\002\!cK4C\002 $chan is not a valid channel"
   }
   ...
   puthelp "NOTICE $nick :\002\!cK4C\002 Chattr $ownern \[${flagss}\]"
   puthelp "NOTICE $nick :\002\!cK4C\002 Global Flags for $ownern are now \[${flags}\]" 
  }
  ...
  save
  puthelp "NOTICE $nick :\002\!cK4C\002 Writing user file ..."
 }
 ...
 if {[matchattr $nick n] == 0} {
  ...
  if {$nflagl != ""} {
   puthelp "NOTICE $nick :\002\!cK4C\002 You do not have access to add or remove the flag 'n' from that user."
   return 0
  }
 }
 ...
 if {([matchattr $nick n] == 0) && ([matchattr $nick  m] == 1) && ([matchattr $ownern m] == 1)} {
  ...
  if {$nflagl != ""} {
   puthelp "NOTICE $nick :\002\!cK4C\002 You do not have access to add or remove the flag 'm' from $ownern."
   return 0
  }
 }
 if {([matchattr $nick n] == 0) && ([matchattr $ownern n] == 0)} {
  if {$chan != ""} {
   if {[validchan $chan]} {
    putcmdlog "\002\!cK4C\002 #$hand# chattr $ownern $flagss"
    if {[string trim $flagss abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ+-] == "|"} {
     chattr $ownern $flagss $chan
    } else {
     chattr $ownern |$flagss $chan
...
proc pub_-host {nick uhost hand chan rest} {
 ...
 set completed 0
 if {($who == "") || ($hostname == "")} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Usage: ${CC}-host <nick> <hostmask>"
  return 0
 }
 if {[validuser $who]==0} {
  puthelp "NOTICE $nick :\002\!cK4C\002 No such user."
 ...
 if {([matchattr $nick n] == 0) && ([matchattr $who n] == 1)} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Can't remove hostmasks from the bot owner."
  return 0
 }
 if {[matchattr $nick m] == 0} {
  if {[string tolower $hand] != [string tolower $who]} {
   puthelp "NOTICE $nick :\002\!cK4C\002 You need '+m' to change other users hostmasks"
   return 0
  }
 }
 foreach * [getuser $who HOSTS] {
  if {${hostname} == ${*}} {
   putcmdlog "\002\!cK4C\002 #$hand# -host $who $hostname"
   delhost $who $hostname
   save 
   puthelp "NOTICE $nick :\002\!cK4C\002 Removed \[${hostname}\] from $who."
    ### Make it do the -host thing here, and any message that goes along with it
   set completed 1
  }
 }
 if {$completed == 0} {
  puthelp "NOTICE $nick :\002\!cK4C\002 No such hostmask!"
 }
}
...
proc pub_+host {nick uhost hand chan rest} {
 ...
 set hostname [lindex $rest 1]
 if {($who == "") || ($hostname == "")} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Usage: ${CC}+host <nick> <new hostmask>"
  return 0
 }
 if {[validuser $who] == 0} {
  puthelp "NOTICE $nick :\002\!cK4C\002 No such user!"
 ...
 foreach * [getuser $who HOSTS] {
  if {${hostname} == ${*}} {
   puthelp "NOTICE $nick :\002\!cK4C\002 That hostmask is already there."
   return 0
  }
 }
 if {($who == "") && ($hostname == "")} {
 ...
 if {([matchattr $nick n] == 0) && ([matchattr $who n] == 1)} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Can't add hostmasks to the bot owner."
  return 0
 }
 foreach * $thehosts {
  if {${hostname} == ${*}} {
   puthelp "NOTICE $nick :\002\!cK4C\002 Invalid hostmask!"
   set badhost 1
  }
 }
 if {$badhost != 1} {
  ...
  puthelp "NOTICE $nick :\002\!cK4C\002 Added \[${hostname}\] to $who."
...
proc pub_-bot {nick uhost hand chan rest} {
 ...
 set bot [lindex $rest 0]
 if {$bot==""} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Usage: ${CC}-bot <handle>"
  return 0
 }
 if {[validuser $bot] == 0} {
  puthelp "NOTICE $nick :\002\!cK4C\002 $bot is not on my userlist."
  return 0
 }
 if {[matchattr $bot b] == 0} {
  puthelp "NOTICE $nick :\002\!cK4C\002 $bot is not a bot on the userlist."
  return 0
 }
 if {[matchattr $bot b] == 1} {
  putcmdlog "\002\!cK4C\002 #$hand# -bot $bot"
  deluser $bot
  puthelp "NOTICE $nick :\002\!cK4C\002 $bot has been deleted from the userlist."
  save
 }
}
## public cmd -bot -- stop
...
proc pub_+bot {nick uhost hand channel rest} {
 ...
 if {[validuser $bot]==1} {
  puthelp "NOTICE $nick :\002\!cK4C\002 $bot is already in my userlist."
  return 0
 }
 if {($bot=="") || ($address=="")} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Usage: ${CC}+bot <botname> <address:botport#\[userport#\]> \[hostmask\]"
  return 0
 }
 ...
 if {[validuser $bot]==0} {
  putcmdlog "\002\!cK4C\002 #$hand# +bot $bot $address $hostmask"
  addbot $bot $address
  if {$hostmask != ""} {
    setuser $bot HOSTS $hostmask
  }
  save
  puthelp "NOTICE $nick :\002\!cK4C\002 $bot \[${address}\] has been add to userlist as a bot."
  return 0
 }
}
## public cmd +bot -- stop
...
proc pub_deluser {nick uhost hand channel rest} {
 ...
 if {$rest == ""} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Usage: ${CC}deluser <handle>"
  return 0
 } else {
...
proc pub_-user {nick uhost hand channel rest} {
 ...
 set who [lindex $rest 0]
 if {$who == ""} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Usage: ${CC}-user <nick>"
 } else {
  if {[validuser $who] == 0} {
   puthelp "NOTICE $nick :\002\!cK4C\002 $who is not on my userlist."
  } else {
   if {[matchattr $who n] == 1}  {
    puthelp "NOTICE $nick :\002\!cK4C\002 You cannot delete a bot owner."
   } else {
    if {([matchattr $who m] == 1) && ([matchattr $nick n] == 0)} {
     puthelp "NOTICE $nick :\002\!cK4C\002 You don't have access to delete $who."
    } else {
     putcmdlog "\002\!cK4C\002 #$hand# -user $who"
     deluser $who
     save
     puthelp "NOTICE $nick :\002\!cK4C\002 $who has been deleted."
    }
   }
  }
 }
...
proc pub_+user {nick uhost hand channel rest} {
 ...
 if {[validuser $who]==1} {
  puthelp "NOTICE $nick :\002\!cK4C\002 $who is already in my userlist."
  return 0
 }
 if {($who=="") || ($hostmask=="")} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Usage: ${CC}+user <nick> <hostmask>"
  return 0
 }
 set who [lindex $rest 0]
 set flags [lindex $rest 2]
 if {[validuser $who]==0} {
  putcmdlog "\002\!cK4C\002 #$hand# +user $who $hostmask"
  adduser $who $hostmask
  save
  puthelp "NOTICE $nick :\002\!cK4C\002 $who has been added to userlist with hostmask \[$hostmask\]."
  if {$flags != ""} {
   chattr $who $flags $channel
   puthelp "NOTICE $nick :\002\!cK4C\002 Added $flags to $who"
  }
  return 0
 }
}
...
proc pub_adduser {nick uhost hand channel rest} {
 ...
 if {[lindex $rest 0] == ""} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Usage: ${CC}adduser <nick> \[optional flags\]"
  return 0
 }
 if {[validuser [lindex $rest 0]]} {
  puthelp "NOTICE $nick :\002\!cK4C\002 $rest is already in my userlist."
  return 0
 }
 if {[onchan [lindex $rest 0] $channel]==1} {
  ...
  putcmdlog "\002\!cK4C\002 #$hand# adduser $who $oflags"
  adduser $who $host
  if {$oflags != ""} {
   if {[lindex $rest 2] != ""} {
    ...
    puthelp "NOTICE $nick :\002\!cK4C\002 $who \[$newhost\] has been added to the userlist."
    puthelp "NOTICE $nick :\002\!cK4C\002 Global Flags for $who are \[${flags}\]"
    set chanflags [chattr [lindex $rest 0] | [lindex $rest 2]]
    set chanflags [string trimleft $chanflags "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ"]
    set chanflags [string trim $chanflags |]
    puthelp "NOTICE $nick :\002\!cK4C\002 Channel \"[lindex $rest 2]\" Flags for $who are \[${chanflags}\]"
    save
    return 0
   } else {
    chattr $who $oflags
   ...
   set flags [chattr $who]
   puthelp "NOTICE $nick :\002\!cK4C\002 $who \[$host\] has been added to the userlist."
   puthelp "NOTICE $nick :\002\!cK4C\002 Global Flags for $who are \[${flags}\]"
   save
   return 0
  }
 ...
 if {[onchan [lindex $rest 0] $channel]==0} {
  puthelp "NOTICE $nick :\002\!cK4C\002 That user is not on $channel."
 }
}
...
proc pub_part {nick uhost hand chan rest} { 
 ...
 if {$rest==""} {
 puthelp "NOTICE $nick :\002\!cK4C\002 Usage: part <#channel>"
  return 0
 } else {
  foreach x [channels] {
   if {[string tolower $x]==[string tolower $rest]} {
    if {[string tolower $rest]==[string tolower $nopart]} {
     puthelp "NOTICE $nick :\002\!cK4C\002 Sorry I can not part $nopart \[PROTECTED\]"
     return 0
    }
    channel remove $rest
    puthelp "NOTICE $nick :\002\!cK4C\002 I have left $x"
    putcmdlog "\002\!cK4C\002 #$hand# part $x"
    return 0
   }
  }
 }
 puthelp "NOTICE $nick :\002\!cK4C\002 I wasn't in $rest"
}
...
proc pub_join {nick uhost hand chan rest} {
 ...
 if {$chan=="#"} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Usage: ${CC}join <#channel>"
 } else {
 foreach x [channels] {
  if {[string tolower $x]==[string tolower $chan]} {
   puthelp "NOTICE $nick :\002\!cK4C\002 Your already in $x"
   return 0
  }
 }
 if {[lindex $rest 1] == ""} {
   puthelp "NOTICE $nick :\002\!cK4C\002 I have joined $chan"
 } else {
   puthelp "NOTICE $nick :\002\!cK4C\002 I have joined $chan (key: [lindex $rest 1])"
 }
 channel add $chan
  if {$rest!=""} {
   putserv "JOIN $chan :[lindex $rest 1]"
   putcmdlog "\002\!cK4C\002 #$hand# join $chan (key: [lindex $rest 1])"
  }
 }
}
...
proc cmd_join {hand idx rest} {
 ...
 if {$chan=="#"} {
  putdcc $idx "\002\!cK4C\002 Usage: join <#channel> \[key\]"
 } else {
 foreach x [channels] { 
  if {[string tolower $x]==[string tolower $chan]} {
   putdcc $idx "\002\!cK4C\002 Your already in $x"
   return 0
  }
 }
 if {[lindex $rest 1] == ""} {
   putdcc $idx "\002\!cK4C\002 I have joined $chan"
 } else {
   putdcc $idx "\002\!cK4C\002 I have joined $chan (key: [lindex $rest 1])"
 }
 channel add $chan
  if {$rest!=""} {
   putserv "JOIN $chan :[lindex $rest 1]"
...
proc cmd_part {hand idx rest} {
 ...
 if {$rest==""} {
 putdcc $idx "\002\!cK4C\002 Usage: part <#channel>"
  return 0
 } else {
  foreach x [channels] {
   if {[string tolower $x]==[string tolower $rest]} {
    if {[string tolower $rest]==[string tolower $nopart]} {
     putdcc $idx "\002\!cK4C\002 Sorry I can not part $nopart \[PROTECTED\]"
     return 0 
    }
    channel remove $rest
    putdcc $idx "\002\!cK4C\002 I have left $x"
    putcmdlog "\002\!cK4C\002 #$hand# part $x"
    return 0
   }
  }
 }
 putdcc $idx "\002\!cK4C\002 I wasn't in $rest"
}
## dcc cmd part -- stop
...
proc cmd_say {hand idx rest} {
 if {$rest==""} {
  putdcc $idx "\002\!cK4C\002 Usage: say <msg>"
 }
 if {$rest!=""} {
  set chan2send [lindex [console $idx] 0]
  puthelp "PRIVMSG $chan2send :$rest"
  putcmdlog "\002\!cK4C\002 #$hand# say $rest"
 }
}
## dcc cmd say -- stop
...
proc cmd_act {hand idx rest} {
 if {$rest==""} {
  putdcc $idx "\002\!cK4C\002 Usage: act <msg>"
 }
 if {$rest!=""} {
  set chan2send [lindex [console $idx] 0]
  putserv "PRIVMSG $chan2send :\001ACTION $rest\001"
  putcmdlog "\002\!cK4C\002 #$hand# act $rest"
 }
}
## dcc cmd act -- stop
...
proc cmd_addlog {hand idx rest} {
 if {$rest==""} {
  putdcc $idx "\002\!cK4C\002 Usage: addlog <log>"
 } else {
  putcmdlog "\002\!cK4C\002 $hand: $rest"
 }
}
## dcc cmd addlog -- stop
...
proc cmd_invite {hand idx rest} {
 ...
 if {$rest==""} {
  putdcc $idx "\002\!cK4C\002 Usage: invite <nick>"
  return 0
 } else {
  if {[onchan $rest $activechan]==1} {
  putdcc $idx "\002\!cK4C\002 $rest is on $activechan already!" 
  return 0
   } else {
   putserv "INVITE $rest :$activechan"
   putdcc $idx "\002\!cK4C\002 Invitation sent to $rest"
   putcmdlog "\002\!cK4C\002 #$hand# invite $rest"
  }
 }
}
...
proc aop_join {nick hand uhost channel} {
 ...
 if {[botisop $channel]!=1} {
  if {$botnick!=$nick} {
   puthelp "NOTICE $nick :\002\!cK4C\002 I would have auto oped you... but I am not oped"
  } 
 } 
}
## cmd aop join -- stop
   ...
   if {$chan != ""} {
    if {[validchan $chan]} {
     if {[matchattr $who |a $chan] == 1} {
      chattr $who |-a $chan
      puthelp "NOTICE $nick :\002\!cK4C\002 $who is no longer auto oped on $chan"
      putlog "\002\!cK4C\002 <<$nick>> !$hand! raop $who $chan"
      return 0
     } else {
      puthelp "NOTICE $nick :\002\!cK4C\002 $who wasn't auto oped on $chan"
      return 0
     }
    } else {
     puthelp "NOTICE $nick :\002\!cK4C\002 $chan is not a valid channel"
    ...
    if {[matchattr $who a] == 1} {
     chattr $who -a
     puthelp "NOTICE $nick :\002\!cK4C\002 $who is no longer a global auto oped"
     putlog "\002\!cK4C\002 <<$nick>> !$hand! raop $who $chan"
     return 0
    } else {
     puthelp "NOTICE $nick :\002\!cK4C\002 $who wasn't auto oped"
     return 0
    }
   }
  }
  if {[validuser $who] == 0} {
   puthelp "NOTICE $nick :\002\!cK4C\002 $who is not a valid user"
  }
 }
 if {$who == ""} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Usage: raop <nick>"
 }
}
## dcc cmd raop -- stop
...
proc pub_aop {nick uhost hand channel rest} {
   ...
   if {$chan != ""} {
    if {[validchan $chan]} {
     if {[matchattr $who |a $chan] == 0} {
      chattr $who |a $chan
      puthelp "NOTICE $nick :\002\!cK4C\002 $who is now auto oped on $chan"
      putlog "\002\!cK4C\002 <<$nick>> !$hand! aop $who $chan"
      return 0
     } else {
      puthelp "NOTICE $nick :\002\!cK4C\002 $who is already auto oped on $chan"
      return 0
     }
    } else {
     puthelp "NOTICE $nick :\002\!cK4C\002 $chan is not a valid channel"
    ...
    if {[matchattr $who a] == 0} {
     chattr $who +a
     puthelp "NOTICE $nick :\002\!cK4C\002 $who is now global auto oped."
     putlog "\002\!cK4C\002 <<$nick>> !$hand! aop $who"
     return 0
    } else {
     puthelp "NOTICE $nick :\002\!cK4C\002 $who is already auto oped"
     return 0
    }  
   }
  }
 ...
 if {$who == ""} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Usage: ${CC}aop <nick>"
 }
}
## public cmd aop -- stop
  ...
  if {[validuser $who] == 1} {
   if {$chan != ""} {
    if {[validchan $chan]} {
     if {[matchattr $who |a $chan] == 0} {
      chattr $who |a $chan
      putdcc $idx "\002\!cK4C\002 $who is now auto oped on $chan"
      putlog "\002\!cK4C\002 <<$nick>> !$hand! aop $who $chan"
      return 0
     } else {
      putdcc $idx "\002\!cK4C\002 $who is already auto oped on $chan"
      return 0
     }
    } else {
     putdcc $idx "\002\!cK4C\002 $chan is not a valid channel"
    ...
    if {[matchattr $who a] == 0} {
     chattr $who +a
     putdcc $idx "\002\!cK4C\002 $who is now global auto oped."
     putlog "\002\!cK4C\002 <<$nick>> !$hand! aop $who"
     return 0
    } else {
     putdcc $idx "\002\!cK4C\002 $who is already auto oped"
     return 0
    }
   }
  }
  if {[validuser $who] == 0} {
   putdcc $idx "\002\!cK4C\002 $who is not a valid user"
  }
 }
 if {$who == ""} {
  putdcc $idx "\002\!cK4C\002 Usage: aop <nick>"
 }
}
## dcc cmd aop -- stop
...
proc pub_channel {nick uhost hand channel rest} {
 ...
 puthelp "NOTICE $nick :\002\!cK4C\002 Channel:$chanlisting" 
 putlog "\002\!cK4C\002 <<$nick>> !$hand! channel"
}
...
proc pub_who {nick uhost hand channel rest} {
 ...
 puthelp "NOTICE $nick :\002\!cK4C\002 People$peoplenum:$peoplelist"
 puthelp "NOTICE $nick :\002\!cK4C\002 Bots$botnum:$botlist" 
 putlog "\002\!cK4C\002 <<$nick>> !$hand! who" 
 return 0
}
## public cmd who -- stop
...
proc pub_whois {nick uhost hand channel rest} { 
 global botnick max-notes
 set fl "\002\!cK4C\002"
 if {[validuser $rest] == 0} {
   putserv "NOTICE $nick :\002\!cK4C\002 No such user!"
   return 0
 }
 set user [lindex $rest 0]
...
proc pub_whom {nick uhost hand channel rest} {
 ...
 puthelp "NOTICE $nick :\002\!cK4C\002 People:$peoplelist"
 putlog "\002\!cK4C\002 <<$nick>> !$hand! whom"
 return 0
}
...
proc pub_match {nick uhost hand chan rest} {
 global CC
 if {$rest==""} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Usage: ${CC}match <flags>"
  return 0
 }
 set rest [string trim $rest +]
 if {[string length $rest] > 1} {
   puthelp "NOTICE $nick :\002\!cK4C\002 Invalid option."
   return 0
 }
 if {$rest!=""} {
  set rest "+[lindex $rest 0]"
  if {[userlist $rest]!=""} {
   ...
   puthelp "NOTICE $nick :\002\!cK4C\002 Match \[$rest\]: $users" 
   putlog "\002\!cK4C\002 <<$nick>> !$hand! match $rest"
   return 0
  }
  if {[userlist $rest]==""} {
   puthelp "NOTICE $nick :\002\!cK4C\002 No users with flags \[$rest\]"
   return 0
  }
 }
}
...
proc dcc_match {hand idx args} {
 ...
 if {$flags==""} {
   putdcc $idx "\002\!cK4C\002 Usage: match <flags>"
   return 0
 }
 if {[string length $flags] > 1} {
   putdcc $idx "\002\!cK4C\002 Invalid Option."
   return 0
 }
 if {$flags!=""} {
  if {[userlist $flags]!=""} {
   regsub -all " " [userlist $flags] ", " users
   putdcc $idx "\002\!cK4C\002 Match \[$flags\]: $users"
   putlog "\002\!cK4C\002 #$hand# match $flags"
   return 0
  }
  if {[userlist $flags]==""} {
   putdcc $idx "\002\!cK4C\002 No users with flags \[$flags\]"
   return 0
  }
 }
}
...
proc pub_bots {nick uhost hand chan rest} {
 if {[bots]==""} {
  puthelp "NOTICE $nick :\002\!cK4C\002 No bots connected"
  putlog "\002\!cK4C\002 <<$nick>> !$hand! bots"
  return 0
 }
 if {[bots]!=""} {
  regsub -all " " [bots] ", " bots
  puthelp "NOTICE $nick :\002\!cK4C\002 Bots: $bots"
  putlog "\002\!cK4C\002 <<$nick>> !$hand! bots"
  return 0
 }
}
...
proc pub_bottree {nick uhost hand chan rest} {
 puthelp "NOTICE $nick :\002\!cK4C\002 Bottree is only available via dcc chat, try Bots" 
}
## public cmd bottree - stop

## public cmd notes -- start
proc pub_notes {nick uhost hand chan rest} {
 puthelp "NOTICE $nick :\002\!cK4C\002 notes is only available via dcc chat"
}
...
proc pub_+ban  {nick uhost hand channel rest} {
 ...
 if {[botisop $channel]==1} {
  if {$rest == ""} {
   puthelp "NOTICE $nick :\002\!cK4C\002 Usage: ${CC}+ban <hostmask> \[reason\]"
   return 0
  }
  if {$rest!=""} {
   ...
   switch -exact  $options {
     perm {
             ...
             if {$reason == ""} {set reason "requested!"}
             putlog "\002\!cK4C\002 <<$nick>> !$hand! +ban $reason"
             return 0
           }
     min {
             if {[val [lindex $reason 1]] == ""} {
...
proc pub_-ban {nick uhost hand channel rest} {
 ...
 if {[matchattr $hand Q] == 0} {
  ...
  if {[botisop $channel]==1} {
   if {$rest==""} {
    puthelp "NOTICE $nick :\002\!cK4C\002 Usage: -ban <ban #>"
   }
  if {$rest!=""} {
   ...
   if {[lindex [banlist $channel] [expr ${rest}-1]]==""} {
    puthelp "NOTICE $nick :\002\!cK4C\002 No such channel ban. It may be a global ban" 
    return 0 
   }  
   if {[lindex [banlist $channel] [expr ${rest}-1]]!=""} {
    set restban [lindex [lindex [banlist $channel] 0] [expr ${rest}-1]]
    killchanban $channel $rest
    puthelp "NOTICE $nick :\002\!cK4C\002 Ban $restban was removed"
    putlog "\002\!cK4C\002 <<$nick>> !$hand! -ban $rest"
    return 0
   }
  }
 }
...
proc pub_bans {nick uhost hand chan rest} {
 ...
 if {$rest!="CHANNEL"} {
  if {$rest!="GLOBAL"} {
   puthelp "NOTICE $nick :\002\!cK4C\002 Usage: bans <global | channel>"
  }
 }
 set banlistchan ""
 if {$rest=="CHANNEL"} {
  ...
  puthelp "NOTICE $nick :\002\!cK4C\002 Channel Bans:$banlistchan"
  putlog "\002\!cK4C\002 <<$nick>> !$hand! bans channel"
  return 0
 }
 set banlist ""
 if {$rest=="GLOBAL"} {
  ...
  puthelp "NOTICE $nick :\002\!cK4C\002 Global Bans:$banlist"
  putlog "\002\!cK4C\002 <<$nick>> !$hand! bans global"
  return 0
 }
}
...
proc cmd_op {hand idx rest} {
 ...
 if {[botisop $channel]==1} { 
  if {$rest==""} {
   putdcc $idx "\002\!cK4C\002 Usage: op <nick>"
  }
  if {[onchan $rest $channel]=="1"} {  
   if {[isop $rest $channel]=="1"} {
    putdcc $idx "\002\!cK4C\002 $rest is already oped"
   }
  }
  if {$rest!=""} {
   if {[onchan $rest $channel]=="0"} {
    putdcc $idx "\002\!cK4C\002 $rest isn't on the channel"
   }
  }
  if {[onchan $rest $channel]=="1"} {
   if {[isop $rest $channel]=="0"} {
    pushmode $channel +o $rest
    putlog "\002\!cK4C\002 #$hand# op $rest"
   }
  }
 }
 if {[botisop $channel]!=1} {
  putdcc $idx "\002\!cK4C\002 I am not oped, sorry."
 }
}
## dcc cmd op -- stop
...
proc pub_op {nick uhost hand channel rest} {
 ...
 if {[botisop $channel]==1} {
  if {$rest==""} {
    ...
    putcmdlog "\002\!cK4C\002 #$hand# op $nick"
    pushmode $channel +o $nick
    return 0
  }
  if {[onchan $rest $channel]==1} {
   if {[isop $rest $channel]==1} {
    puthelp "NOTICE $nick :\002\!cK4C\002 $rest is already oped."
   }
  }
  if {$rest!=""} {
   if {[onchan $rest $channel]==0} {
    puthelp "NOTICE $nick :\002\!cK4C\002 $rest isn't on the channel."
   }
  }
  if {[onchan $rest $channel]==1} {
   if {[isop $rest $channel]==0} {
    pushmode $channel +o $rest 
    putlog "\002\!cK4C\002 <<$nick>> !$hand! op $rest"
   }
  }
 }
 if {[botisop $channel]!=1} {
  puthelp "NOTICE $nick :\002\!cK4C\002 I am not oped, sorry."
 }
}
## public cmd op -- stop
...
proc cmd_deop {hand idx rest} {
 ...
 if {[botisop $channel]==1} { 
  if {$rest==""} {
   putdcc $idx "\002\!cK4C\002 Usage: deop <nick>"
  }
  if {$rest!=""} {
   if {[onchan $rest $channel]=="0"} {
    putdcc $idx "\002\!cK4C\002 $rest isn't on the channel"
  ...
  if {[onchan $rest $channel]=="1"} {
   if {[isop $rest $channel]=="0"} {
    putdcc $idx "\002\!cK4C\002 $rest is already deoped"
   }
  }
  if {[string tolower $botnick] == [string tolower $rest]} {
   putdcc $idx "\002\!cK4C\002 I don't deop myself..."
  }
  if {[isop $rest $channel]=="1"} {
   if {[onchan $rest $channel]=="1"} {
    if {$botnick!=$rest} {
     pushmode $channel -o $rest
     putlog "\002\!cK4C\002 #$hand# deop $rest"
    }
   }
  } 
 }
 if {[botisop $channel]!=1} {
  putdcc $idx "\002\!cK4C\002 I am not oped"
 }
}
## dcc cmd deop -- stop
...
proc pub_deop {nick uhost hand channel rest} {
 ...
 if {[botisop $channel]==1} {
  if {$rest==""} {
    ...
    putcmdlog "\002\!cK4C\002 #$hand# deop $nick"
    pushmode $channel -o $nick
    return 0
  }
  if {$rest!=""} {
  ...
  if {[onchan $rest $channel]=="1"} {
   if {[isop $rest $channel]=="0"} {
    puthelp "NOTICE $nick :\002\!cK4C\002 $rest is already deoped."
    return 0
   }
  }
  if {[string tolower $botnick] == [string tolower $rest]} {
  ...
  if {[isop $rest $channel]=="1"} {
   if {[onchan $rest $channel]=="1"} {
    if {[string tolower $botnick] != [string tolower $rest]} {
     pushmode $channel -o $rest
     putlog "\002\!cK4C\002 <<$nick>> !$hand! deop $rest"
    }
   }
  }
 }
...
proc pub_topic {nick uhost hand channel rest} {
 ...
 if {$rest!=""} {
  if {[botisop $channel]==1} {
   if {$topicnick == 0} {
     ...
     putlog "\002\!cK4C\002 <<$nick>> !$hand! topic $rest" 
   } else {
 ...
 if {$rest==""} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Usage: topic <topic>"
 }
}
...
proc pub_act {nick uhost hand channel rest} {
 if {$rest!=""} {
  putserv "PRIVMSG $channel :\001ACTION $rest\001"
  putlog "\002\!cK4C\002 <<$nick>> !$hand! act $rest"
  return 0
 }
 if {$rest==""} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Usage: act <msg>"
 }
}
## public cmd act -- stop
...
proc pub_say {nick uhost hand channel rest} {
 if {$rest!=""} {
  ...
  putlog "\002\!cK4C\002 <<$nick>> !$hand! say $rest"
  return 0
 }
 if {$rest==""} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Usage: say <msg>"
 }
}
## public cmd say -- stop
...
proc pub_msg {nick uhost hand channel rest} {
 ...
 if {$rest!=""} {
  ...
  putlog "\002\!cK4C\002 <<$nick>> !$hand! msg $rest"
  return 0
 }
 if {$rest==""} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Usage: msg <nick> <msg>"
 }
}
## public cmd msg -- stop
...
proc pub_motd {nick uhost hand channel rest} {
 ...
 if {![file exists $mfile]} {
   ...
   putserv "NOTICE $nick :I am $botnick, running v[lindex $version 0] with cK4C.tcl v${vers}"
   puts $new "I am $botnick, running v[lindex $version 0] with cK4C.tcl v${vers}"
...
proc pub_addlog {nick uhost hand chan rest} {
 ...
 if {$rest==""} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Usage: addlog <msg>"
 }
 if {$rest!=""} {
  putlog "\002\!cK4C\002 $hand: $rest"
 }
}
...
proc pub_invite {nick uhost hand chan rest} {
 ...
 set rest [lindex $rest 0]
 if {$rest==""} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Usage: invite <nick>"
 }
 if {$rest!=""} {
  if {[onchan $rest $chan]==0} {
   putserv "INVITE $rest :$chan"
   puthelp "NOTICE $nick :\002\!cK4C\002 Invitation to $chan has been sent to $rest" 
   putlog "\002\!cK4C\002 <<$nick>> !$hand! invite $rest"
   return 0
  }
  if {[onchan $rest $chan]==1} {
   puthelp "NOTICE $nick :\002\!cK4C\002 $rest is already on the channel"
  }
 }
}
## public cmd invite -- stop
...
proc pub_nick {nick uhost hand chan rest} {
 ...
 set rest [lindex $rest 0]
 if {$rest==""} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Usage: nick <new nick on bot>"
 }
 if {$rest!=""} {
  chnick $hand $rest
  puthelp "NOTICE $nick :\002\!cK4C\002 Your partyline handle is now [nick2hand $nick $chan]" 
  putlog "\002\!cK4C\002 <<$nick>> !$hand! nick $rest"
  return 0
 }
}
...
## Away stuff ##
set idle.v "cK4C AntiIdle Technology"
set idle.1 10
set idle.w "$botnick"
set idle.m "!ping"
if {![info exists idle.l]} {
  ...
  set idle.l 0
  timer ${idle.1} {idle.a}
  putlog "\002\!cK4C\002 Loading ${idle.v}..."
}
...
proc pub_chat {nick uhost hand chan rest} {
 puthelp "NOTICE $nick :\002\!cK4C\002 Chat is only available via dcc chat"
}
...
proc pub_note {nick uhost hand chan rest} {
 ...
 set rest [lrange $rest 1 end]
 if {$rest==""} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Usage: note <hand> <note>"
 }
 if {$rest!=""} {
  set notetest [sendnote $hand $reciever $rest]
  if {$notetest==1} {
   puthelp "NOTICE $nick :\002\!cK4C\002 Note to $reciever was recieved"
  }
  if {$notetest==2} {
   puthelp "NOTICE $nick :\002\!cK4C\002 Note to $reciever was stored \[local\]"
  }
  if {$notetest==3} {
   puthelp "NOTICE $nick :\002\!cK4C\002 ${reciever}'s mailbox was full"
  }
  if {$notetest==4} {
   puthelp "NOTICE $nick :\002\!cK4C\002 Tcl binding intercepted the note"
  }
  if {$notetest==5} {
   puthelp "NOTICE $nick :\002\!cK4C\002 $reciever was away, note stored"
  }
  if {$notetest==0} {
   puthelp "NOTICE $nick :Send to $reciever failed" 
   return 0
  }
  putlog "\002\!cK4C\002 <<$nick>> !$hand! note $reciever *masked*"
 }
}
## public cmd chat -- stop
...
proc pub_files {nick uhost hand chan rest} {
 ...
 if {$wowfiles!=""} {
 set z 0
 puthelp "NOTICE $nick :\002\!cK4C\002 $botnick is offering [llength $wowfiles] packs, type .get \[X\] to recieve a file" 
 foreach x $wowfiles { 
  set z [expr $z+1]
  set sizeoffile [string trim [exec du dcc/$x] dcc/$x]
   ...
   puthelp "NOTICE $nick :\002\!cK4C\002 $z) $wowfiles"
  }
 }
 if {$wowfiles==""} {set wowfiles "No files available"}  
 if {$wowdirs==""} {set wowdirs "No directories available"}
 if {$wowfiles=="No files available"} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Files: $wowfiles"
 }
 puthelp "NOTICE $nick :\002\!cK4C\002 Directories: $wowdirs"
 puthelp "NOTICE $nick :\002\!cK4C\002 Many more commands available via dcc chat" 
 putlog "\002\!cK4C\002 <<$nick>> !$hand! files"
 return 0
}
...
proc pub_newpass {nick uhost hand chan rest} {
 puthelp "NOTICE $nick :\002\!cK4C\002 Newpass: For some reason, I think not"
}
## public cmd newpass -- stop

## public cmd console -- start
proc pub_console {nick uhost hand chan rest} {
 puthelp "NOTICE $nick :\002\!cK4C\002 Console is only available via dcc chat"
}
...
proc pub_servers {nick uhost hand chan rest} {
 global server
 puthelp "NOTICE $nick :\002\!cK4C\002 Server: Current Server is $server"
 putlog "\002\!cK4C\002 <<$nick>> !$hand! servers"
 return 0
}
...
puthelp "NOTICE $nick :\002\!cK4C\002 quit is only available via dcc chat."
}
...
proc pub_k {nick uhost hand channel rest} { 
 ...
 if {$rest==""} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Usage: ${CC}k <nick> \[reason\]"
 }
 if {$rest!=""} {
...
proc pub_kick {nick uhost hand channel rest} {
 ...
 if {[botisop $channel]==1} {
  if {$rest == ""} {
   puthelp "NOTICE $nick :\002\!cK4C\002 Usage: kick <nick> \[reason\]"
   return 0
  }
  set handle [lindex $rest 0]
  set reason [lrange $rest 1 end]
  ...
  if {[string tolower $handle] == [string tolower $botnick]} {
   putserv "KICK $channel $nick :do NOT mess with $botnick! !cK4C-v7a"
   return 0
  } else {
   if {[matchattr $handle n] == 1} {
    putserv "KICK $channel $nick :do NOT mess with my owner! !cK4C-v7a"
   return 0
   } else {
    putserv "KICK $channel $handle :(k) $reason !cK4C-v7a"
    if {$reason == ""} {set reason "requested!"}
    putcmdlog "\002\!cK4C\002 #$hand# kick $handle $reason"
    return 0
   }
  }
 }
...
proc cmd_mdeop {hand idx arg} {
 ...
 if {$args == ""} {
  putdcc $idx "\002\!cK4C\002 Usage: mdeop <#channel>"
 }
 if {$args != ""} {  
...
proc cmd_mop {hand idx arg} {
 ...
 set args [lindex $arg 0]
 if {$args == ""} {
  putdcc $idx "\002\!cK4C\002 Usage: mop <#channel>"
 }
 if {$args != ""} {
...
proc pub_massdeop {nick uhost hand chan rest} {
 ...
 if {$mass==1} {
  ...
  putserv "MODE $chan -oooooo $deopnicks"
  putlog "\002\!cK4C\002 #$hand# massdeop"
 }
}
...
proc pub_massop {nick uhost hand chan rest} {
 ...
 if {$mass == 1} {
  ...
  pushmode $chan +oooooo $opnicks
  putlog "\002\!cK4C\002 #$hand# massop"
 }
}
...
proc dcc_massdeop {hand idx arg} {
 ...
 if {$chan == ""} {
  putdcc $idx "\002\!cK4C\002 Usage: massdeop <#channel>"
  return 1
 }
 if {$mass==1} {
  set deopnicks ""
...
proc dcc_massop {hand idx arg} {
 ...
 set chan [lindex $arg 0]
 if {$chan == ""} {
  putdcc $idx "\002\!cK4C\002 Usage: massop <#channel>"
  return 1
 }
 if {$mass == 1} {
  set opnicks ""
...
proc pub_kickban  {nick uhost hand channel rest} {
 ...
 if {[botisop $channel]==1} {
  if {$rest == ""} {
   puthelp "NOTICE $nick :\002\!cK4C\002 Usage: ${CC}kickban <nick> \[reason\]"
   return 0
  }
  if {$rest!=""} {
   set handle [lindex $rest 0]
   ...
   switch -exact  $options {
     perm {
             ...
             newchanban $channel $hostmask $nick "$reason" 0
             if {$reason == ""} {set reason "requested!"}
             putlog "\002\!cK4C\002 <<$nick>> !$hand! kicban $channel $hostmask $options $reason"
             putserv "KICK $channel $handle :!cK4C-v7a7\[4!KiCk $reason7\]"
             return 0
           }
     min {
             if {[val [lindex $reason 1]] == ""} {
...
proc pub_kb  {nick uhost hand channel rest} {
 ...
 if {[botisop $channel]==1} {
  if {$rest == ""} {
   puthelp "NOTICE $nick :\002\!cK4C\002 Usage: ${CC}kb <nick> \[reason\]"
   return 0
  }
  if {$rest!=""} {
   set handle [lindex $rest 0]
...
# return 0
 ...
 if {$wowthatinfo==""} {set wowthatinfo "No info is set"}
  puthelp "NOTICE $nick :\002\!cK4C\002 Info: $wowthatinfo"
  putlog "\002\!cK4C\002 <<$nick>> !$hand! info"
  return 0
 }
 if {$rest!=""} {
  if {[string toupper $rest]=="NONE"} {
   setuser $hand info ""
   puthelp "NOTICE $nick :\002\!cK4C\002 Your info has been cleared"
   putlog "\002\!cK4C\002 <<$nick>> !$hand! info none"
   return 0
  }
  if {[string toupper $rest]!="NONE"} {
   setuser $hand info $rest
   puthelp "NOTICE $nick :\002\!cK4C\002 Your info is now $rest"
   putlog "\002\!cK4C\002 <<$nick>> !$hand! info $rest"
   return 0
  }
 }
}
...
proc pub_get {nick uhost hand chan rest} {
 ...
 set rest [lindex $rest 0]
 if {$rest==""} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Usage: get <file #>"
 }
 if {$rest!=""} {
  set f 0
  ...
  if {$f==1} {
   puthelp "NOTICE $nick :\002\!cK4C\002 Sending you [lrange [getfiles /] $numberoffile $numberoffile]" 
   dccsend dcc/[lrange [getfiles /] $numberoffile $numberoffile] $nick
   putlog "\002\!cK4C\002 <<$nick>> !$hand! get $rest"
   return 0
  } 
  if {$f!="1"} {
   puhelp "NOTICE $nick :\002\!cK4C\002 Incorrect file number"
  }
 }
}
## public cmd get -- stop
...
proc cmd_userlist {hand idx args} {
 ...
 set f [lindex $args 0]
 if {[userlist $f] ==""} {
  putdcc $idx "\002\!cK4C\002 No users with flag(s) $f."
  putcmdlog "\002\!cK4C\002 #$hand# userlist $f"
  return 0
 }
 if {[userlist $f] !=""} {
  regsub -all " " [userlist $f]  ", " userlist
  putdcc $idx "\002\!cK4C\002 Userlist: $userlist"
  putcmdlog "\002\!cK4C\002 #$hand# userlist $f"
  return 0
 }
}
...
proc pub_userlist {nick uhost hand chan rest} {
 ...
 set f [lindex $rest 0]
 if {[userlist $f] ==""} {
  puthelp "NOTICE $nick :\002\!cK4C\002 No users with flag(s) \[$f\]"
  putlog "\002\!cK4C\002 <<$nick>> !$hand! userlist $f"
}
if {[userlist $f] !=""} {
 set tester $f
 if {$tester!=""} {set tester " \[$tester\]"}
  regsub -all " " [userlist $f]  ", " userlist 
  puthelp "NOTICE $nick :\002\!cK4C\002 Userlist$tester: $userlist"
  putlog "\002\!cK4C\002 <<$nick>> !$hand! userlist $f"
 }
}
...
proc pub_ping {nick uhost hand chan rest} {
 ...
 putlog "\002\!cK4C\002 <<$nick>> !$hand! ping"
}
...
proc pub_pong {nick uhost hand chan rest} {
 ...
 putlog "\002\!cK4C\002 <<$nick>> !$hand! pong"
}
## public cmd pong -- stop

## dcc cmd channels -- start
proc cmd_channels {hand idx args} {
 putdcc $idx "\002\!cK4C\002 Channels: [channels]"
 putcmdlog "\002\!cK4C\002 #$hand# channels"
}
...
proc cmd_global {hand idx args} {
 ...
 if {$gsay!=""} {
  ...
  putcmdlog "\002\!cK4C\002  #$hand# global $gsay"
 }
 if {$gsay==""} {
 putdcc $idx "\002\!cK4C\002 Usage: global <msg>"
 }
}
## dcc global -- stop
...
proc cmd_flagnote {hand idx arg} {
 ...
 if {$whichflag == "" || $message == ""} {
  putdcc $idx "\002\!cK4C\002 Usage: flagnote <flag> <msg>"
  return 0
 }
 ...
 if {([lsearch -exact $botflags $normwhichflag] > 0)} {
  putdcc $idx "\002\!cK4C\002 The flag $boldwhichflag is for bots only"
  putdcc $idx "\002\!cK4C\002 Choose from the following: $oldflags $newflags"
  return 0
 }
 if {([lsearch -exact $oldflags $normwhichflag] < 0) && ([lsearch -exact $botflags $normwhichflag] < 0)} {
  putdcc $idx "\002\!cK4C\002 The flag $boldwhichflag is not a defined flag"
  putdcc $idx "\002\!cK4C\002 Choose from the following: $oldflags"
  return 0
 }
 putlog "\002\!cK4C\002 #$hand# flagnote [string tolower \[+$whichflag\]] ..."
 putdcc $idx "\002\!cK4C\002  Sending FlagNote to all $boldwhichflag users"
...
proc pub_time {nick uhost hand chan rest} {
 ...
 if {$fronttime == "00"} {
  puthelp "NOTICE $nick :\002\!cK4C\002 The current time is 12$backtime AM $timezone"
  putlog "\002\!cK4C\002 <<$nick>> !$hand! time"
  return 0
 }
 if {$fronttime < 12} {
  puthelp "NOTICE $nick :\002\!cK4C\002 The current time is $fronttime$backtime AM $timezone"
  putlog "\002\!cK4C\002 <<$nick>> !$hand! time"
  return 0
 }
 if {$fronttime >= 12} {
  putserv "NOTICE $nick :\002\!cK4C\002 The current time is [expr $fronttime-12]$backtime PM $timezone"
  putlog "\002\!cK4C\002 <<$nick>> !$hand! time"
  return 0
 }
}
...
proc pub_down {nick uhost hand channel rest} {
 ...
 if {[botisop $channel] != 1} {
  puthelp "NOTICE $nick :\002\!cK4C\002 Im not oped, sorry."
  return 0
 }
 if {[isop $nick $channel] == 1} {
  putlog "\002\!cK4C\002 <<$nick>> !$hand! down"
  pushmode $channel -o $nick
 } else {
  puthelp "NOTICE $nick :\002\!cK4C\002 You are already deoped."
  return 0
 }
}
...
proc pub_up {nick uhost hand channel rest} {
 ...
 if {[isop $nick $channel] == 0} {
  putlog "\002\!cK4C\002 <<$nick>> !$hand! up"
  pushmode $channel +o $nick
 } else {
  puthelp "NOTICE $nick :\002\!cK4C\002 You are already oped."
  return 0
 }
}
## public cmd up -- stop

putlog "\002\!cK4C\002 *** cKc.tcl $vers loaded."
